...
export default function PortfolioPage() {
  ...
  const communityWork = [
    ...
    { title: 'Executive', server: 'CoastSMP', desc: 'Coordinated a team of staff members, handled player relations, and managed day-to-day operations for the Minecraft server.', website: 'https://store.coastsmp.net/', discord: 'https://discord.gg/invite/coastsmp', retired: true, active: false },
      ...
      <section id="contact" className="w-full py-16 bg-primary/20 flex flex-col items-center relative z-10">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
          ...
          <div className="flex flex-col items-center space-y-4">
            <motion.a
              href="mailto:soulforgelabs@gmail.com"
